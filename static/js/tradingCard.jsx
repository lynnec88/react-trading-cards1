...
ReactDOM.render(
  <TradingCard name="Off-By-One" skill="climbing mountains" imgUrl="/static/img/off-by-one.jpeg" />,
  document.querySelector('#off-by-one'),
);

ReactDOM.render(
  <TradingCard name="Seed.py" skill="costumes" imgUrl="/static/img/seedpy.jpeg" />,
  document.querySelector('#seedpy'),
);

ReactDOM.render(
  <TradingCard name="Polymorphism" skill="making curry dishes" imgUrl="/static/img/polymorphism.jpeg" />,
  document.querySelector('#polymorphism'),
);

ReactDOM.render(
  <TradingCard name="Short Stack Overflow" skill="ocean animal trivia" imgUrl="/static/img/shortstack-overflow.jpeg" />,
